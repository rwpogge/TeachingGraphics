...
respectively (9 data tables).  Data are calculated by ATRAN.

For MidIR (6-28um), the data are provided for airmass 1.5 for water columns
of 1.0, 1.6, 3.0, and 5.0mm of precipitable water.
